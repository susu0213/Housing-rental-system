 ...
 */
@WebServlet("/HouseOneServlet.do")
public class HouseOneServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("background/HouseEdit.jsp").forward(request,response);
    }
