                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td valign="bottom"><h3 style="letter-spacing:1px;">用户留言</h3></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <td colspan="2">
                                    <form action="" method="">
                                        <table width="100%"  class="cont tr_color">
                                            ...
                                            <c:forEach items="${pager.datas}" var="message" varStatus="vs">
                                            <tr align="center" class="d">
                                                <td>${message['userMessage']}</td>
                                                <td>${message['adminMessage']}</td>
                                                <td><a href="../BMessageOne.do?id=${message['id']}">查看</a>
                                            </tr>
                                            </c:forEach>
                                        </table>
                                    </form>
