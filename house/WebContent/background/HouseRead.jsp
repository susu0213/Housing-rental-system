            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td valign="bottom"><h3 style="letter-spacing:1px;">未批准房屋信息</h3></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                    ...
                                    <form action="" method="">
                                        <table width="100%"  class="cont tr_color">
                                            ...
                                            <tr align="center" class="d">
                                                ...
                                                <td><a href="../HouseAgree.do?id=${house['id']}&houseAdmin=${sessionScope['Admin']['account']}">同意</a> <a href="../HouseDAgree.do?id=${house['id']}&houseLord=${house['houseLord']}" onclick="return DCheck()">拒绝</a> <a href="../HouseOneServlet.do?id=${house['id']}&read=${read}">查看</a></td>
                                            </tr>
                                            </c:forEach>
                                        </table>
                                    </form>
                ...
                <tr>
                    ...
                    <td width="51%" class="left_txt">
                        <form action="../BHouseServlet.do" method="post">
