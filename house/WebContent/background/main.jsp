            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td colspan="2" valign="top">
                        <h3 style="margin:0 0 10px 10px;">感谢您使用房屋租赁网站管理系统</h3>
                        <img src="./Images/ts.gif" width="16" height="16" style="margin-left:10px;"> 提示：<br />
                        <p style="text-indent:20px;line-height:25px;margin-left:10px;font-size:15px;">您现在使用的是房屋租赁网站管理系统</p>
                    </td>
                    <!--间隔-->
                    <td width="7%">&nbsp;</td>
                    <!--右边内容-->
