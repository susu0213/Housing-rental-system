                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td valign="bottom"><h3 style="letter-spacing:1px;">用户列表</h3></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                    ...
                                    <form action="" method="">
                                        <table width="100%"  class="cont tr_color">
                                            ...
                                            <tr align="center" class="d">
                                                ...
                                                <td>${user['tel']}</td>
                                                <td>${user['email']}</td>
                                                <td><a href="../UserOne.do?id=${user['id']}">查看</a><c:if test="${user['account'] ne sessionScope['Admin']['account']}"> <a href="../UserDelete.do?id=${user['id']}" onclick="return DCheck()"> 删除</a></c:if>
                                            </tr>
                                            </c:forEach>
                                        </table>
                                    </form>
